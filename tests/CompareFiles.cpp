...
// The worse encountered difference was 1.43% on Label_Simple.png, so errors smaller than 1.5%
// are allowed. Small errors will thus go unnoticed, but it is better than not checking at all.
